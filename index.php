...
<body class="overflow-x-hidden">
  ...
  <!-- About Section -->
  <section id="about" class="px-[10%] py-20 bg-[#F1E9D4] flex flex-col md:flex-row items-center gap-14">
    <!-- IMAGE (centered on mobile, right on desktop) -->
    <div class="relative w-full md:w-1/2 flex justify-center">
      <div class="relative b">
        <img src="Properties/About_Section/about.png" alt="Sandwich" class="rounded-[20px] z-10 relative" />
    ...
    <div class="w-full md:w-1/2 text-[#102f76] text-center md:text-left">
      <h2 class="text-[48px] font-bold mb-6 about-title no-copy underline decoration-[#c8161d] underline-offset-[10px]">
        About Us
      </h2>

      <p class="text-[14px] md:text-[18px] text-left md leading-relaxed mb-10 p-4">
  ...
  <!-- Checkerboard -->
  <img src="Properties/About_Section/checkered.png" alt="Checkerboard" class="w-[1900px] md:w-full" />

  <div id="menuPopup" class="menu-popup">
    <div id="popupData" data-id="" data-name="" data-price="" style="display:none;"></div>
    <div class="menu-content card-style">
      ...
      <div class="menu-detail">
        ...
        <div class="menu-popUp-desc text-center relative">
          <div id="popupTitle" class="title-container text-3xl font-bold"></div>

          <div class="relative star-wrapper">
            <img src="Properties/Menu_Section/bintang.png" class="absolute w-9 star-1" />
            <img src="Properties/Menu_Section/bintang.png" class="absolute w-9 star-2" />
          </div>
          ...
          <button class="add-cart-btn" onclick="addToCart()">Checkout
  ...
  <div id="cartNotif" class="notification" role="alert" aria-live="assertive">
    ...
    <button class="close-button" aria-label="Close notification" onclick="this.parentElement.style.display='none';">
      &times;
    </button>
  </div>
  ...
  <section id="menu" class="menu bg-[#102F76] text-white text-center py-12">
    ...
    <div class="px-10 flex items-center justify-center md:justify-start mb-8">
      <a href="Login-Admin.html">
        <img src="Properties/Menu_Section/bintang.png" class="w-[30px] mt-[60px]" />
      </a>
      <h1 class="text-[50px] font-bold text-[#FFF8E5]" style="font-family: 'Cooper Black', sans-serif">
        Our Menu
      </h1>
      <a href="LoginAdmin.php">
        <img src="Properties/Menu_Section/bintang.png" class="w-[30px] mb-[60px]" />
      </a>
    </div>
    ...
    <div class="px-10 py-[8px] md:py-4 flex justify-between items-center">
      ...
      <!-- RIGHT BUTTON GROUP -->
      <div class="flex md:gap-5 gap-[10px] items-center md:mr-[550px] overflow-x-auto scroll-smooth"
        id="variant-scroll">
    ...
    <div id="menuList" class="mt-10 flex flex-wrap justify-center gap-10 px-6 md:w-auto mx-auto">
      <!-- JS akan isi disini -->
    </div>
  </section>
  ...
  <div id="cartPopup" class="cart-popup">
    <div class="cart-content">
      ...
      <div class="cart-box">
        <h2 class="cart-title underline decoration-[#F6D932] underline-offset-4">
          Keranjang
        </h2>
        <table>
          <thead>
  ...
  <section
    ...
    <div class="mx-auto">
      ...
      <div
        ...
        <a href="#" target="_blank"
          class="bg-[#F6D932] w-[65px] h-[65px] sm:w-24 sm:h-[130px] sm:w-[130px] md:w-[200px] md:h-[100px] rounded-[25px] flex items-center justify-center shadow-[0_4px_5px_rgba(0,0,0,0.25)] hover:scale-105 transition">
          <img src="Properties/Order_Via_Section/gojek_1.png" alt="GoFood" class="w-[30px] sm:w-12" />
        </a>

        <a href="#" target="_blank"
          class="bg-[#F6D932] w-[65px] h-[65px] sm:w-24 sm:h-[130px] sm:w-[130px] md:w-[200px] md:h-[100px] rounded-[25px] flex items-center justify-center shadow-[0_4px_5px_rgba(0,0,0,0.25)] hover:scale-105 transition">
          <img src="Properties/Order_Via_Section/grab.png" alt="GrabFood" class="w-10 sm:w-12 md:w-[100px]" />
        </a>

        <a href="https://shopee.co.id/universal-link/now-food/shop/22348963?deep_and_deferred=1&shareChannel=copy_link"
          target="_blank"
          class="bg-[#F6D932] w-[65px] h-[65px] sm:w-24 sm:h-[130px] sm:w-[130px] md:w-[200px] md:h-[100px] rounded-[25px] flex items-center justify-center shadow-[0_4px_5px_rgba(0,0,0,0.25)] hover:scale-105 transition">
          <img src="Properties/Order_Via_Section/shopee_1.png" alt="ShopeeFood" class="w-[30px] sm:w-12" />
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="bg-[#F1E9D4] py-16 px-6 md:px-20">
    ...
    <div class="flex flex-col lg:flex-row justify-center items-center gap-12 max-w-6xl mx-auto">
      ...
      <!-- RIGHT: Rating Form -->
      <div class="bg-[#102F76] text-[#fff8e5] rounded-[40px] p-8 w-full max-w-[420px] drop-shadow-[0_4px_16px_#0b2b89]">
        ...
        <div id="starContainer" class="flex gap-2 mb-6 text-2xl text-white">
          <i class="fa-regular fa-star cursor-pointer border-[1px] border-[#fff8e5] p-2 rounded-[10px] px-[13px] md:px-4"
            data-value="1"></i>
          <i class="fa-regular fa-star cursor-pointer border-[1px] border-[#fff8e5] p-2 rounded-[10px] px-[13px] md:px-4"
            data-value="2"></i>
          <i class="fa-regular fa-star cursor-pointer border-[1px] border-[#fff8e5] p-2 rounded-[10px] px-[13px] md:px-4"
  ...
  <section class="py-20 no-copy" id="loc">
    <div class="checkered">
      <img src="Properties/location_checker.png" alt=""
        class="w-[900px] absolute z-1 opacity-[10%] right-0 md:mt-[10px] mt-[145px] mt-[340px]" />
    </div>
    <div class="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 items-center gap-10">
      <!-- LEFT: MAP -->
      <div class="relative flex justify-center items-center">
        ...
        <!-- Embed Map utama -->
        <iframe class="relative w-[260px] md:w-[360px] h-[220px] md:h-[360px] shadow-lg rotate-[-3deg]"
      ...
      <div class="text-center">
        ...
        <p class="text-[#0a2458] title-font font-semibold text-lg mb-6 relative">
      ...
      <div class="checkered">
        <img src="Properties/footer_checker.png" alt="Checkerboard"
  ...
  <footer class="bg-[#0b2b68] text-white pt-10 pb-6 no-copy">
    <div class="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-10 items-start">
      <!-- LEFT SIDE -->
      <div>
      ...
      <div class="flex flex-col md:items-end mr-[40px] md:mr-0 gap-4">
        ...
        <div class="text-center">
          ...
          <div class="flex gap-4 text-xl justify-center">
            <a href="https://www.instagram.com/rootsbar._/" target="_blank"
              class="text-[#f9dd3c] hover:text-white transition icon-social">
              <i class="fa-brands fa-instagram"></i>
            </a>
            <a href="https://www.tiktok.com/@rootsbarr" target="_blank"
              class="text-[#f9dd3c] hover:text-white transition icon-social">
    ...
    <div class="checkered">
      <img src="Properties/checker_3.png" alt="Checkerboard" class="w-[1600px] mt-[17px]" />
    </div>
