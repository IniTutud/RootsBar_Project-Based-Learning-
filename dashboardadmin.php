...
<head>
  ...
  <title>ROOT'S BAR Dashboard</title>
  ...
  <aside class="w-64 bg-[#1e3a8a] flex flex-col justify-between py-6">
      <div>
        ...
        <nav class="space-y-2 px-3">
          <a href="#" class="flex items-center gap-3 py-3 px-6 bg-white text-[#1e3a8a] rounded-full font-semibold shadow-md">
  ...
  <input id="searchOrder" type="text" placeholder="Cari" 
    ...
    <div class="bg-red-500 p-8 rounded-3xl shadow-xl transform hover:scale-105 transition relative overflow-hidden">
      ...
      <section class="px-6 pb-6 flex-1">
        <h3 class="text-3xl font-extrabold mb-4">Recent Order</h3>
